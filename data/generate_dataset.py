...
# =========================================================
TOTAL_SUDOKUS = 25000 
TRAIN_SUDOKUS = 20000 #/ 20000 Sudoku eğitim verisi
TEST_SUDOKUS = 5000 #/ 5000 Sudoku test verisi
...
def create_dataset(number_of_sudokus): 
    X, y = [], []
    ...
    for i in range(number_of_sudokus):
        ...
        puzzle = create_puzzle(solution, empty_cells)
